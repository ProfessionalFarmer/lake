#!/usr/bin/env python
import sys
# From https://github.com/DeWitP/SFG/tree/master/scripts
# $1 vcf input $2 output prefix $3 minimun snp quality $4 popfile sample id in vcf and population $5 samples do not consider 
#
...
pops={l.strip().split()[0]:l.strip().split()[1] for l in open(sys.argv[4])}
