...
# other like hgmd
perl $annovar  ${in}.avinput $db  -nastring . -outfile $out.temp  -remove -otherinfo -protocol refGene,genomicSuperDups,phastConsElements46way,esp6500siv2_all,1000g2012apr_all,1000g2014oct_all,1000g2014oct_eas,cosmic70,clinvar_20150629,avsnp142,ljb26_all,gwasCatalog -operation g,r,r,f,f,f,f,f,f,f,f,r -nastring .
