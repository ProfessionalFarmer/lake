...
# popfreq_all_20150413 include 1000g2015aug_all 
perl $annovar  ${in}.avinput $db  -nastring . --thread 8 -outfile $out.temp  -remove -otherinfo -protocol refGene,genomicSuperDups,phastConsElements46way,popfreq_all_20150413,avsnp142,cosmic70,clinvar_20160302,dbnsfp30a,gwasCatalog -operation g,r,r,f,f,f,f,f,r > /dev/null
