#! /usr/bin/env python
#
# This script is in https://github.com/mkschuster/bsfpython/blob/ . I download, modify and use it.
#
...
for line in input_fh:
    ...
    if sample_fields[genotype_index] == '0/0':
        ...
        continue
    # consider 1/2 genotype
    elif sample_fields[genotype_index] == '1/2':
        alleles = vcf_fields[4].split(',')[0] + vcf_fields[4].split(',')[1]
    else:
	#continue # by zzx, ignore unexpected information
    ...
    # by zzx
    if vcf_fields[2]=='.' or len(alleles)!=2:
	continue
