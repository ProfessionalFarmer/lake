...
bash ~/lake/pipeline/fastq-trimmonmatic-1.0.1.sh -1 $fq1 -2 $fq2 -s $smp -o $dir
# relink fq file
...
java -jar $gatk \
    ...
    --filterExpression "DP < 10" --filterName "lowDP" --filterExpression "QD < 2.0" --filterName "lowQD" --filterExpression "FS > 60.0" --filterName "highFS" --filterExpression "MQ < 10.0" --filterName "lowMQ"   \
...
java -jar $gatk \
    ...
    --filterExpression "DP < 10" --filterName "lowDP" --filterExpression "QD < 2.0" --filterName "lowQD" --filterExpression "FS > 200" --filterName "highFS" \
...
##################################################################
cp $0 ${dir}/${smp}.analysis_script.sh 
